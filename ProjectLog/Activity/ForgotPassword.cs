...
namespace ProjectLog
{
    ...
    public class ForgotPassword : AppCompatActivity, IOnClickListener, IOnCompleteListener
    {
        ...
        public void OnComplete(Task task)
        {
            ...
            {
                Snackbar snack = Snackbar.Make(activity_forgot, "Reset Password failed!", Snackbar.LengthLong);
                    snack.Show();
            }
            else
            {
                Snackbar snack = Snackbar.Make(activity_forgot, "Reset password link sent to email :" + input_email.Text, Snackbar.LengthLong);
                    snack.Show();
            }
        }
    }
